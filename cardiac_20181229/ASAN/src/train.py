...
if FLAGS.task_detail != 'dia' and FLAGS.task_detail != 'sys' and FLAGS.task_detail != 'A' and FLAGS.task_detail != 'N':
    raise NotImplementedError('choose "dia" or "sys" or "A" or "N", got {}'.format(FLAGS.task_detail))
process = Preprocess()
...
cbs.append(CSVLogger('{}/checkpoint_{}_{}.log'.format(FLAGS.checkpoint_dir,FLAGS.chd_hcmp,FLAGS.task_detail), append=True))
